...
type ReviewAppealInfo struct {
	...
	Status    int32      `gorm:"column:status;not null;comment:状态:10-待处理，20-处理中，30-已处理" json:"status"`              // 状态:10-待处理，20-处理中，30-已处理
	Reason    string     `gorm:"column:reason;not null;comment:申诉原因" json:"reason"`                                 // 申诉原因
	Content   string     `gorm:"column:content;not null;comment:申诉内容" json:"content"`                               // 申诉内容
	...
	OpRemark  string     `gorm:"column:op_remark;not null;comment:处理备注" json:"op_remark"`                           // 处理备注
	OpUser    string     `gorm:"column:op_user;not null;comment:处理人" json:"op_user"`                                // 处理人
