...
func newReviewAppealInfo(db *gorm.DB, opts ...gen.DOOption) reviewAppealInfo {
	...
	_reviewAppealInfo.OpRemark = field.NewString(tableName, "op_remark")
...
type reviewAppealInfo struct {
	...
	Status    field.Int32  // 状态:10-待处理，20-处理中，30-已处理
	Reason    field.String // 申诉原因
	Content   field.String // 申诉内容
	PicInfo   field.String // 图片信息json
	VideoInfo field.String // 视频信息json
	OpRemark  field.String // 处理备注
	OpUser    field.String // 处理人
