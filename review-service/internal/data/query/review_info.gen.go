...
func newReviewInfo(db *gorm.DB, opts ...gen.DOOption) reviewInfo {
	...
	_reviewInfo.Socore = field.NewInt32(tableName, "socore")
	...
	_reviewInfo.OpRemark = field.NewString(tableName, "op_remark")
...
type reviewInfo struct {
	...
	ALL            field.Asterisk
	ID             field.Int64  // 主键
	CreateBy       field.String // 创建方式标识
	UpdateBy       field.String // 更新方式标识
...
func (r *reviewInfo) updateTableName(table string) *reviewInfo {
	...
	r.Socore = field.NewInt32(table, "socore")
	...
	r.OpRemark = field.NewString(table, "op_remark")
...
func (r *reviewInfo) fillFieldMap() {
	...
	r.fieldMap["op_remark"] = r.OpRemark
