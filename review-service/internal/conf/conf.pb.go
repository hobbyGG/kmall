...
type Snowflake struct {
	...
	MechineId     int64                  `protobuf:"varint,2,opt,name=mechine_id,json=mechineId,proto3" json:"mechine_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\n" +
	"mechine_id\x18\x02 \x01(\x03R\tmechineId\"u\n" +
	"\bRegistry\x123\n" +
	...
	"\aaddress\x18\x01 \x03(\tR\aaddressB#Z!review-service/internal/conf;confb\x06proto3"
